...
Let's just take the base claim that <BlueHighlighter>AI can write code 10x faster than any developer.</BlueHighlighter> Or better still, faster delivery or 10 times more code output... of which I am not convinced. 
