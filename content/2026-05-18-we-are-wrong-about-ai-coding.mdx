...
published: true
description: "AI didn't kill the job market. The economy did."
canonical_url: https://temisan.vercel.app/blog/we-are-wrong-about-ai-coding
cover_image: https://res.cloudinary.com/dgi0pwcxz/image/upload/v1779140767/m4dunqarfwsmolthfko6.jpg
---

![AI coding claims — overwhelming noise](https://res.cloudinary.com/dgi0pwcxz/image/upload/v1779124135/uc6m2gvydi8d4w4u46tv.png)
...
Let's just take the base claim that **_AI can write code 10x faster than any developer._** Or better still, faster delivery or 10 times more code output... of which I am not convinced.
...
![Option A vs Option B — fire your team or multiply them](https://res.cloudinary.com/dgi0pwcxz/image/upload/v1779138078/r9dthhbm6dzp1gqhadhm.jpg)
...
**_AI is probably getting more blame than it deserves._**
...
![Historical timeline — new tools have always boosted developers, never replaced them](https://res.cloudinary.com/dgi0pwcxz/image/upload/v1779137188/slhqieai1t4xgpltm7tz.jpg)
...
A **_competent developer using AI_** will outbuild and outship someone who isn't. That doesn't mean less work though. It means more features, bigger products, wilder ambitions.

![Dev + AI vs Dev alone — the gap widens over time](https://res.cloudinary.com/dgi0pwcxz/image/upload/v1779136770/frexgdtoueekhicsjq64.jpg)

That's my take anyway. See you in the next one.¹

---

*¹ Idea credit: [Kyle Cook — Web Dev Simplified](https://www.youtube.com/@WebDevSimplified)*