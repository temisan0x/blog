      ...
      <div className="container mx-auto px-6">
        ...
        <Link href="/" className="text-white relative text-2xl" passHref>
          ...
          <div className="hidden md:flex space-x-10 font-san">
            ...
            <Link href="/work" className="text-gray-300 text-sm hover:text-white">Work</Link>
          </div>
          <div className="md:hidden">
            <button onClick={() => setIsOpen(!isOpen)} className="focus:outline-none">
              <svg className="h-6 w-6 text-gray-300 hover:text-white" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 font-san">
              ...
              <Link href="/work" className="block px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700">Work</Link>
            </div>
          </div>
        )}
      </div>
