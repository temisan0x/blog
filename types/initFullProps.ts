const initFullProps = {
  ...
  toolbar:
    "fullscreen preview print | undo redo | sizeselect | fontselect |  fontsizeselect| bold italic backcolor |  \
       ...
       numlist bullist outdent indent | removeformat | restoredraft wordcount | bold italic numlist",
  plugins: [
    "wordcount ",
    "link print ",
    "preview fullscreen",
  ...
  setup: (editor: {
    ui: {
      registry: {
        addIcon: (arg0: string, arg1: string) => void;
        addButton: (
          arg0: string,
          arg1: {
            text: string;
    ...
    execCommand: (arg0: string, arg1: boolean, arg2: string) => void;
  }) => {
  ...
  content_style: `
    ...
    figure {
      outline: 3px solid  background: rgb(16, 16, 16);
      position: relative;
