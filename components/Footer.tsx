...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-900 py-5 px-6 ">
      <div className="flex flex-col items-center relative">
        ...
        <div className="flex gap-3">
          <Link
            passHref
            href="/temisan"
            className="text-gray-400 hover:text-gray-400 text-[15px] font-bold"
          >
            About
          </Link>
          <Link
        ...
        <div className="flex gap-3 mt-2 text-gray-400 text-[15px] font-bold">
